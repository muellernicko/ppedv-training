...
internal class Program
{
    static void Main(string[] args)
    {
        ...
        ints.Add(5); //Add (T item) wird zu Add(int item)
        ...
        ints.Remove(3); //Keine leeren Elemente/Elemente werde aufgeschoben
        ...
        Console.WriteLine(einwohnerzahlen["Wien"]); //Holt den Wert hinter dem gegeben Key
        ...
        //einwohnerzahlen.Add("Paris", 2_160_000); //Der selber Key darf nicht zweimal existieren
